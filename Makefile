...
obj/lodepng/lodepng.o: source/lodepng/lodepng.cpp
	@mkdir -p $(@D)
	$(CXXFLAGS) $< -o $@ -DLODEPNG_NO_COMPILE_ENCODER -DLODEPNG_NO_CXXFLAGS -Wno-zero-as-null-pointer-constant -Wno-alloc-zero -Wno-cast-qual
