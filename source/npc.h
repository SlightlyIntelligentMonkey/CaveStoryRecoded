...
enum NPCNames
{
	...
	NPC_ProjectileMannanRedBlast = 103,
	NPC_EnemyFrog = 104,
	NPC_SpeechBalloonHeyLow = 105,
	NPC_SpeechBalloonHeyHigh = 106,
	NPC_MalcoUndamaged = 107,
	NPC_ProjectileBalfrogSpitball = 108,
	NPC_MalcoDamaged = 109,
	NPC_EnemyPuchi = 110,
	NPC_QuoteTeleportingOut = 111,
	NPC_QuoteTeleportingIn = 112,
	NPC_ProfessorBooster = 113,
	NPC_EnemyPress = 114,	// Immediately falls with gravity
	NPC_EnemyRavil = 115,
	NPC_RedFlowersPetals = 116,
	NPC_CurlyStanding = 117,
	NPC_BossCurly = 118,
	NPC_TableAndChair = 119,
	NPC_Colon1 = 120,
	NPC_Colon2 = 121,
	NPC_EnemyColon = 122,
	NPC_ProjectileCurlyMachineGunBullet = 123,
	NPC_Sunstone = 124,
	NPC_HiddenHeartMissile = 125,	// Direction 0 = Heart, 2 = Missile. Always turns into the Direction 2 version of pickup, Destroyed when below 990HP (0x3DE)
	NPC_PuppyRunning = 126,
	NPC_ProjectileMachineGunTrailLevel2 = 127,
	NPC_ProjectileMachineGunTrailLevel3 = 128,
	NPC_ProjectileFireballSnakeTrail = 129,
	NPC_PuppyWaggingTail = 130,
	NPC_PuppySleeping = 131,
	NPC_PuppyBarking = 132,
	NPC_Jenka = 144,
